      ...
      <aside class="detail" aria-live="polite">
        <template v-if="selectedNode">
          ...
          <div class="source-links">
            <a class="source-link source-link--primary" :href="nodeUrl(selectedNode.id)">打开站内节点详情 →</a>
            <a class="source-link" :href="sourceUrl(selectedNode.source_path)" target="_blank" rel="noopener">GitHub 源文件</a>
          </div>
        </template>
        <template v-else>
